...
Certifique-se de que o arquivo **`app.py`** contém aquele código começando com `import streamlit as st`. É ele quem vai gerar a interface gráfica quando você rodar o comando `streamlit run src/app.py`.

Fazendo essa troca no texto do `README.md` da pasta `src/`, seu repositório fica 100% livre. 
